...
switch ($q)
{
	...
	case "New PO":
		...
		$sql = "SELECT $table.no, $ptable.rev, $ptable.eo FROM $table INNER JOIN $ptable ON $ptable.no = $table.no WHERE $table.drawing = '$linkvalue' ORDER BY $pprimaryfield DESC";
		break;
}
//create query
