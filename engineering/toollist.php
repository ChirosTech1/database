<html>
<head><h1>Part Number Tooling List</h1></head>
<script type="text/javascript" src="../script/ajax.js"></script>
<script type="text/javascript">
//<![CDATA{
var formtype = "Tooling";
var mainfile = "engineering";
var mainform = "gtoollist.php";
var lineform = "gltoollist.php";
var noteform = "";
var printform = "ptoollist.php";
var selectfield = "tool";
var table = "pn";
var field = "no";
var field2 = "des";
...
<form id="printform">
<input type="button" value="Print Tooling" onclick="PrintForm('print')"/>
</form>
<p/>
<form id = "main">
<table>
