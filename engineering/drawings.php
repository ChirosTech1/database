<html>
<head><h1>Hamby Supplemental Drawings</h1></head>
...
var noteform = "";
var printform = "pdrawings.php";
var table = "suppdrawing";
var field = "no";
var field2 = "note";
...
$sql = "SELECT no FROM suppdrawing ORDER BY no";
...
<input type="button" value="New Drawing" onclick="UpdateForm(this.value)"/>
<input type="button" value="Delete Drawing" onclick="UpdateForm(this.value)"/>
<p/>
<form id = "main">
<table>
<tr>
