<html>
<head><h1>Part Number Specification List</h1></head>
<script type="text/javascript" src="../script/ajax.js"></script>
<script type="text/javascript">
//<![CDATA{
var formtype = "Specification";
var mainfile = "documentctrl";
var mainform = "gspeclist.php";
var lineform = "glspeclist.php";
var noteform = "";
var printform = "pspeclist.php";
var selectfield = "spec";
var table = "pn";
var field = "no";
var field2 = "des";
...
<form id="printform">
<input type="button" value="Print Specification" onclick="PrintForm()"/>
</form>
<p/>
<form id = "main">
<table>
