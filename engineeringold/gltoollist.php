...
?>
	...
	<tr>
	<td><input type="text" id="<?php echo $i;?>" name="type" size="10"/></td>
	<td><input type="text" id="<?php echo $i;?>" name="tool" size="10"/></td>
	<td><input type="text" id="<?php echo $i;?>" name="note" size="50"/></td>
...
?>
	...
	<td><input type="text" id="<?php echo $i;?>" name="type" size="10" value="<?php echo $row['pntype'];?>"/></td>
	<td><input type="text" id="<?php echo $i;?>" name="no" size="10" value="<?php echo $row['pnno'];?>"/></td>
