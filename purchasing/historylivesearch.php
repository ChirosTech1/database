...
$sql = "SELECT DISTINCT $field, $field2, $field3 FROM $table WHERE $field LIKE '%" . $search . "%' OR $field2 LIKE '%" . $search . "%' OR $field3 LIKE '%" . $search . "%'";
