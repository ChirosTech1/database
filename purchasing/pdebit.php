...
<table class="top">
<tr>
<td class="formname" width="25%">Debit Memo</td>
<th colspan="2" class="head"><?php echo $crow['company'];?></th>
<td class="head" width="25%"></td>
</tr>
<tr>
<td class="formname" width="25%">Form</td>
...
<td class="pono"><?php echo "DM" . $no;?></td>
</table>
<p/>
...
if($k < $pagehigh)
$lsql = "SELECT * FROM poline WHERE no = '$no' AND callno = $callno ORDER BY line";
}
...
<td class="line" width="10%"><?php switch($_GET[$i]){case "Original Debit Memo": case "Purchasing Copy": case "Accounting Copy": case "File Copy": echo "$".$up; break;}?></td>
<td class="line" width="10%"><?php switch($_GET[$i]){case "Original Debit Memo": case "Purchasing Copy": case "Accounting Copy": case "File Copy": echo "$".$lp; break;}?></td>
<?php
}
else
{
...
<td class="line"><?php switch($_GET[$i]){case "Original Debit Memo": case "Purchasing Copy": case "Accounting Copy": case "File Copy": echo "$".$subtot; break;}?></td>
</tr>
<tr>
<td class="line"></td>
<td class="line"></td>
...
<td class="line"><?php switch($_GET[$i]){case "Original Debit Memo": case "Purchasing Copy": case "Accounting Copy": case "File Copy": echo "$".$taxtot; break;}?></td>
</tr>
<tr>
<td class="line"></td>
<td class="line"></td>
...
<td class="line"><?php switch($_GET[$i]){case "Original Debit Memo": case "Purchasing Copy": case "Accounting Copy": case "File Copy": echo "$".$tot; break;}?></td>
</tr>
<?php
}
?>
